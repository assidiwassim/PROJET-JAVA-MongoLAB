...
public class Recette extends javax.swing.JFrame {
    ...
    public Recette() {
       ...
       float s=0;
        ...
        {DBObject obj = cursor.next();
           s+=(double)obj.get("prix");
            
            
            }
        jLabel4.setText(Float.toString(s));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("la recette est de");

        jLabel4.setBackground(new java.awt.Color(250, 8, 40));
        jLabel4.setForeground(new java.awt.Color(255, 0, 31));
        jLabel4.setText("     ");

        jLabel5.setText("DTTC");
